...
![람다의 구성 요소.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/JAVA8/ch3/ch3_1.png)
* **람다 바디** : 반환값에 해당하는 표현식.
  ```
...
* **메소드의 파라미터 부분을 람다의 파라미터**에, **메소드의 리턴을 람다의 바디에 매칭**시킨다.
  ![람다 매핑.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/JAVA8/ch3/ch3_2.png)
